        ...
        <section id="sign-up-page">
            ...
            <div class="container">
                ...
                if (isset($_POST['submit_sign_up'])) {
                    ...
                    $req = $bdd->prepare('INSERT INTO users(first_name ,last_name, gender, email, password, birthdate, company_name, employee_number, isSupervisor) VALUES(:first_name, :last_name, :gender, :email, :password, :birthdate, :company_name, :employee_number, :isSupervisor)');
                    $req->execute(array(
